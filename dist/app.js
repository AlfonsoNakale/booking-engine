...
function $1e090edbfad0295e$export$c86caf1be068fb8d(price) {
  try {
    ...
    return `${$1e090edbfad0295e$var$state.currentCurrency} ${
      price * $1e090edbfad0295e$var$state.exchangeRate
    }`;
  }
}
 ...
 */ function $1e090edbfad0295e$var$addEventListeners() {
  ...
  document
    ...
    .forEach((input) =>
      input.addEventListener(
        "change",
        $1e090edbfad0295e$var$handleCurrencyChange
      )
    );
}
/**
 ...
 */ async function $1e090edbfad0295e$var$fetchExchangeRate() {
  if ($1e090edbfad0295e$var$state.currentCurrency === "NAD") {
    $1e090edbfad0295e$var$state.exchangeRate =
      $1e090edbfad0295e$export$3a9d962e09421de3.DEFAULT_EXCHANGE_RATE;
    return;
  }
  try {
    // Fetch exchange rate from API
    const response = await fetch(
      `${$1e090edbfad0295e$var$API_CONFIG.BASE_URL}/${$1e090edbfad0295e$var$API_CONFIG.KEY}/pair/NAD/${$1e090edbfad0295e$var$state.currentCurrency}`
    );
    if (!response.ok) throw new Error(`HTTP error! status: ${response.status}`);
    const data = await response.json();
    if (data.result === "success")
      $1e090edbfad0295e$var$state.exchangeRate = data.conversion_rate;
...
function $1e090edbfad0295e$export$b1c48fe9bd5d022f() {
  ...
  if (selectedVehicle) {
    ...
    $1e090edbfad0295e$var$updatePriceElementValues(
      priceElement,
      nadPrice,
      convertedPrice
    );
 ...
 */ function $1e090edbfad0295e$var$updatePriceElementValues(
  element,
  nadPrice,
  convertedPrice
) {
 ...
 */ function $1e090edbfad0295e$var$getPickupFee() {
  ...
  if (pickupConfirmation && pickupConfirmation.checked)
    return $1e090edbfad0295e$export$3a9d962e09421de3.BASE_PICKUP_FEE;
  else {
...
function $1e090edbfad0295e$export$83b33c17a49accc1() {
  ...
  if (pickupFeeElement) {
    if (locationValue)
      $1e090edbfad0295e$var$updatePriceElement(
        "v-price-pickup",
        $1e090edbfad0295e$export$3a9d962e09421de3.BASE_PICKUP_FEE
      );
...
function $1e090edbfad0295e$export$76cc2ce412a00fb9() {
  ...
  if (!isPickupConfirmed) {
    ...
    if (pickupFeeElement)
      $1e090edbfad0295e$var$clearPriceElement(pickupFeeElement);
 ...
 */ const $682918f8353579e8$var$calculateDurationDays =
  $682918f8353579e8$var$memoize((pickupDate, returnDate) => {
 ...
 */ function $682918f8353579e8$var$calculateDuration() {
  const pickupDate = (0, $hJpwG$flatpickr)("#datetimes-pickup")
    .selectedDates[0];
  const returnDate = (0, $hJpwG$flatpickr)("#datetimes-return")
    .selectedDates[0];
  const durationElement = document.getElementById("v-duration");
 ...
 */ function $682918f8353579e8$var$updateExtras() {
    ...
    if (checkbox && priceElement && quantityInput) {
      if (checkbox.checked) {
        ...
        priceElement.dataset.convertedValue = (
          nadPrice *
          (0, $1e090edbfad0295e$export$50fdfeece43146fd)().exchangeRate
        ).toFixed(2);
        priceElement.textContent = (0,
        $1e090edbfad0295e$export$c86caf1be068fb8d)(nadPrice);
  ...
  if (totalExtrasElement) {
    ...
    $1e090edbfad0295e$export$c86caf1be068fb8d)(totalExtras);
  }
}
...
function $2dd5f9dccafe7e70$export$de01a5d2298a9bfb() {
  ...
  $2dd5f9dccafe7e70$var$pickupPicker = $2dd5f9dccafe7e70$var$createDatePicker(
    "#datetimes-pickup",
    {
      ...commonConfig,
      defaultDate: today,
  ...
  $2dd5f9dccafe7e70$var$returnPicker = $2dd5f9dccafe7e70$var$createDatePicker(
    "#datetimes-return",
    {
      ...commonConfig,
 ...
 */ function $2dd5f9dccafe7e70$var$createDatePicker(selector, config) {
  ...
  input.addEventListener("input", () =>
    $2dd5f9dccafe7e70$var$validateManualDateInput(input, picker)
  );
  return picker;
}
/**
 ...
 */ function $2dd5f9dccafe7e70$var$handlePickupDateClose(selectedDates) {
  if (selectedDates[0]) {
    ...
    if (
      $2dd5f9dccafe7e70$var$returnPicker.selectedDates[0] &&
      $2dd5f9dccafe7e70$var$returnPicker.selectedDates[0] < minReturnDate
    )
      $2dd5f9dccafe7e70$var$returnPicker.setDate(minReturnDate);
  }
  (0, $682918f8353579e8$export$1a76a6d47efc9b3e)();
}
/**
 ...
 */ function $157e9ba0b1ce1572$export$b67d05e9c9fe4b31() {
  ...
  const debouncedValidation = $157e9ba0b1ce1572$var$debounce((field) => {
    if (field.value.trim()) {
      if (
        field.type === "email" &&
        !$157e9ba0b1ce1572$var$isValidEmail(field.value)
      )
        $157e9ba0b1ce1572$var$showError(
          field,
 ...
 */ function $157e9ba0b1ce1572$var$validateForm() {
  ...
  if (
    emailField &&
    emailField.value &&
    !$157e9ba0b1ce1572$var$isValidEmail(emailField.value)
  ) {
    isValid = false;
  ...
  errors.forEach((message, field) =>
    $157e9ba0b1ce1572$var$showError(field, message)
  );
  return isValid;
}
// Regular expression for email validation
const $157e9ba0b1ce1572$var$EMAIL_REGEX =
