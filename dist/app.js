...
var _pricingCalculationJs = require("./pricingCalculation.js");
var _bookingDetailsJs = require("./bookingDetails.js");
"use strict";
window.Webflow ||= [];
window.Webflow.push(()=>{
    (0, _datePickerJs.initializeDatePickers)();
    (0, _bookingDetailsJs.initializeBookingDetails)();
    (0, _formValidationJs.initializeFormValidation)();
    (0, _pricingCalculationJs.initializePricingCalculation)();
});

},{"./datePicker.js":"kGIag","./formValidation.js":"3r0oh","./pricingCalculation.js":"9bkWP","./bookingDetails.js":"feaH9"}],"kGIag":[function(require,module,exports) {
...
function initializeDatePickers() {
    ...
    const commonConfig = {
        ...
        onChange: (0, _bookingDetailsJs.updateBookingDetails)
    };
    ...
    returnPicker = createDatePicker("#datetimes-return", {
        ...
        onClose: (0, _bookingDetailsJs.updateBookingDetails)
    });
    pickupPicker.setDate(today);
    returnPicker.setDate(fiveDaysLater);
    (0, _bookingDetailsJs.updateBookingDetails)();
}
/**
 ...
 */ function createDatePicker(selector, config) {
    const picker = (0, _flatpickrDefault.default)(selector, config);
 ...
 */ function handlePickupDateClose(selectedDates) {
    if (selectedDates[0]) {
        ...
        if (returnPicker.selectedDates[0] && returnPicker.selectedDates[0] < minReturnDate) returnPicker.setDate(minReturnDate);
    }
    (0, _bookingDetailsJs.updateBookingDetails)();
}
/**
 ...
 */ function validateManualDateInput(input, picker) {
    ...
    const parsedDate = (0, _flatpickrDefault.default).parseDate(dateValue, "Y-m-d");
...
},{"flatpickr":"llQu5","./bookingDetails.js":"feaH9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"feaH9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Main function to update all booking details
 * Calls various update functions to refresh the UI
 */ parcelHelpers.export(exports, "updateBookingDetails", ()=>updateBookingDetails);
/**
 * Initializes pickup location functionality
 */ parcelHelpers.export(exports, "initializePickupLocation", ()=>initializePickupLocation);
/**
 * Initializes all dynamic updates and event listeners
 * Sets up handlers for inputs, extras, and location changes
 */ parcelHelpers.export(exports, "initializeDynamicUpdates", ()=>initializeDynamicUpdates);
/**
 * Initializes the booking details module
 * Sets up initial date displays and updates
 */ parcelHelpers.export(exports, "initializeBookingDetails", ()=>initializeBookingDetails);
var _flatpickr = require("flatpickr");
var _flatpickrDefault = parcelHelpers.interopDefault(_flatpickr);
var _pricingCalculationJs = require("./pricingCalculation.js");
/**
...
function updateBookingDetails() {
    calculateDuration();
    (0, _pricingCalculationJs.updatePricing)();
    (0, _pricingCalculationJs.calculateTotal)();
    updateVehicleName();
 ...
 */ function calculateDuration() {
    const pickupDate = (0, _flatpickrDefault.default)("#datetimes-pickup").selectedDates[0];
    const returnDate = (0, _flatpickrDefault.default)("#datetimes-return").selectedDates[0];
 ...
 */ function updateDateDisplays() {
    const pickupPicker = (0, _flatpickrDefault.default)("#datetimes-pickup");
    const returnPicker = (0, _flatpickrDefault.default)("#datetimes-return");
 ...
 */ function updateExtras() {
    ...
    extras.forEach((extra)=>{
        ...
        if (checkbox && priceElement && quantityInput) {
            if (checkbox.checked) {
                ...
                priceElement.dataset.convertedValue = (nadPrice * (0, _pricingCalculationJs.getState)().exchangeRate).toFixed(2);
                priceElement.textContent = (0, _pricingCalculationJs.formatPrice)(nadPrice);
    ...
    if (totalExtrasElement) {
        ...
        totalExtrasElement.dataset.convertedValue = (totalExtras * (0, _pricingCalculationJs.getState)().exchangeRate).toFixed(2);
        totalExtrasElement.textContent = (0, _pricingCalculationJs.formatPrice)(totalExtras);
    }
}
function initializeDynamicUpdates() {
    ...
    document.querySelectorAll("input, select").forEach((input)=>{
        if (input.id !== "pickup-error-wrapper") {
            ...
            if (input.type !== "checkbox" && input.type !== "radio") input.addEventListener("input", updateBookingDetails);
        }
    });
    ...
    if (currentLocationInput) currentLocationInput.addEventListener("input", updatePickupLocation);
    ...
    if (pickupConfirmation) {
        pickupConfirmation.addEventListener("change", ()=>{
            (0, _pricingCalculationJs.handlePickupConfirmationChange)();
            updateBookingDetails();
        });
        (0, _pricingCalculationJs.handlePickupConfirmationChange)();
    }
...
},{"flatpickr":"llQu5","./pricingCalculation.js":"9bkWP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9bkWP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PRICING_CONSTANTS", ()=>PRICING_CONSTANTS);
/**
 ...
 */ parcelHelpers.export(exports, "initializePricingCalculation", ()=>initializePricingCalculation);
/**
 * Updates the pricing display based on selected vehicle
 * Converts prices to selected currency
 */ parcelHelpers.export(exports, "updatePricing", ()=>updatePricing);
/**
 * Calculates total price including vehicle price, extras, pickup fee, and tax
 */ parcelHelpers.export(exports, "calculateTotal", ()=>calculateTotal);
/**
 * Handles changes to the location input
 * Updates pickup fee and recalculates total
 */ parcelHelpers.export(exports, "handleLocationChange", ()=>handleLocationChange);
/**
 * Handles changes to pickup confirmation checkbox
 * Shows/hides location input and updates pricing accordingly
 */ parcelHelpers.export(exports, "handlePickupConfirmationChange", ()=>handlePickupConfirmationChange);
var _bookingDetailsJs = require("./bookingDetails.js");
 ...
 */ function addEventListeners() {
    ...
    document.querySelectorAll('input[name="vehicle"]').forEach((input)=>input.addEventListener("change", (0, _bookingDetailsJs.updateBookingDetails)));
    // Add listeners to currency selection radio buttons
    document.querySelectorAll('input[name="currency-group"]').forEach((input)=>input.addEventListener("change", handleCurrencyChange));
}
/**
 ...
 */ async function fetchExchangeRate() {
    ...
    try {
        ...
        const response = await fetch(`${API_CONFIG.BASE_URL}/${API_CONFIG.KEY}/pair/NAD/${state.currentCurrency}`);
 ...
 */ function getPickupFee() {
    ...
    if (pickupConfirmation && pickupConfirmation.checked) return PRICING_CONSTANTS.BASE_PICKUP_FEE;
    else {
...
function handleLocationChange() {
    ...
    if (pickupFeeElement) {
        if (locationValue) updatePriceElement("v-price-pickup", PRICING_CONSTANTS.BASE_PICKUP_FEE);
        else clearPriceElement(pickupFeeElement);
    }
    calculateTotal();
}
function handlePickupConfirmationChange() {
    const pickupConfirmation = document.getElementById("pickup-confirmation");
    ...
    if (locationInput) {
        ...
        if (locationInput.value.trim()) handleLocationChange();
    }
    calculateTotal();
}
/**
...
},{"./bookingDetails.js":"feaH9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3r0oh":[function(require,module,exports) {
/**
 * Initializes form validation
 * Sets up event listeners for real-time validation
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initializeFormValidation", ()=>initializeFormValidation);
function initializeFormValidation() {
    ...
    const debouncedValidation = debounce((field)=>{
        if (field.value.trim()) {
            if (field.type === "email" && !isValidEmail(field.value)) showError(field, "Please enter a valid email address");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lQsD6","5AKj5"], "5AKj5", "parcelRequiredd51")
